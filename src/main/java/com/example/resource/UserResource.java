...
public class UserResource {
    ...
    @GET
    @Path("/{id}/roles")
    public Uni<List<Role>> getUserRoles(@PathParam("id") Long id) {
    ...
    public Uni<Role> getUserRoleInfo(@PathParam("id") Long id,@PathParam("roleId") Long roleId) {
        return userService.getUserRole(id,roleId);
    }
